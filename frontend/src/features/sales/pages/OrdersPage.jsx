    ...
    <>
      ...
      <div className="flex flex-col md:flex-row gap-6 mb-6">
        <InfoCard
          ...
          number={summaryLoading ? '...' : totalOrders.toLocaleString(activeLocale)}
        ...
        <InfoCard
          ...
          iconComponent={Clock}
          number={summaryLoading ? '...' : pendingOrders.toLocaleString(activeLocale)}
        ...
        <InfoCard
          ...
          number={summaryLoading ? '...' : completedOrders.toLocaleString(activeLocale)}
