const i18nKeyContainer = {
    ...
    products: {
        ...
        addProductForm: {
            ...
            sections: {
                productInformation:
                    'products.addProductForm.sections.productInformation',
                pricingInformation:
                    'products.addProductForm.sections.pricingInformation',
                inventoryManagement:
                    'products.addProductForm.sections.inventoryManagement',
        ...
        productTable: {
            ...
            toasts: {
                deleteCancelledTitle:
                    'products.productTable.toasts.deleteCancelledTitle',
                ...
                deleteSuccessMessage:
                    'products.productTable.toasts.deleteSuccessMessage',
            },
        },
        productView: {
            ...
            sections: {
                ...
                deletionInformation:
                    'products.productView.sections.deletionInformation',
            },
            fields: {
        ...
        categories: {
            ...
            form: {
                ...
                placeholders: {
                    ...
                    parentCategory:
                        'products.categories.form.placeholders.parentCategory',
                },
                validation: {
            ...
            view: {
                ...
                sections: {
                    categoryInformation:
                        'products.categories.view.sections.categoryInformation',
                    subcategories: 'products.categories.view.sections.subcategories',
                    auditInformation:
                        'products.categories.view.sections.auditInformation',
                ...
                placeholders: {
                    ...
                    noSubcategories:
                        'products.categories.view.placeholders.noSubcategories',
        ...
        units: {
            ...
            form: {
                ...
                toasts: {
                    ...
                    createSuccessMessage:
                        'products.units.form.toasts.createSuccessMessage',
                    ...
                    updateSuccessMessage:
                        'products.units.form.toasts.updateSuccessMessage',
            ...
            table: {
                ...
                toasts: {
                    ...
                    deleteSuccessMessage:
                        'products.units.table.toasts.deleteSuccessMessage',
        ...
        categoryManagement: {
            ...
            table: {
                ...
                columns: {
                    ...
                    description: 'customers.categoryManagement.table.columns.description',
                ...
                dialogs: {
                    ...
                    cancelDelete:
                        'customers.categoryManagement.table.dialogs.cancelDelete',
                },
                toasts: {
                    loadFailedTitle:
            ...
            form: {
                ...
                validation: {
                    ...
                    nameTooLong:
                        'customers.categoryManagement.form.validation.nameTooLong',
                    descriptionTooLong:
            ...
            view: {
                ...
                actions: {
                    ...
                    editCategory:
                        'customers.categoryManagement.view.actions.editCategory',
                },
                sections: {
    ...
    inventory: {
        ...
        inventoryForm: {
            ...
            sections: {
                ...
                productInformation:
                    'inventory.inventoryForm.sections.productInformation',
                locationInformation:
            ...
            actions: {
                ...
                updateStockLevels: 'inventory.inventoryForm.actions.updateStockLevels',
            },
            toasts: {
        ...
        inventoryView: {
            ...
            sections: {
                productInformation:
                    'inventory.inventoryView.sections.productInformation',
                locationInformation:
        ...
        locations: {
            ...
            form: {
                ...
                sections: {
                    locationInformation:
                        'inventory.locations.form.sections.locationInformation',
                },
                fields: {
                ...
                validation: {
                    ...
                    addressRequired:
                        'inventory.locations.form.validation.addressRequired',
                ...
                toasts: {
                    ...
                    createSuccessTitle:
                        'inventory.locations.form.toasts.createSuccessTitle',
                    createSuccessMessage:
                        'inventory.locations.form.toasts.createSuccessMessage',
                    createFailedTitle:
                        'inventory.locations.form.toasts.createFailedTitle',
                    createFailedMessage:
                        'inventory.locations.form.toasts.createFailedMessage',
                    updateSuccessTitle:
                        'inventory.locations.form.toasts.updateSuccessTitle',
                    updateSuccessMessage:
                        'inventory.locations.form.toasts.updateSuccessMessage',
                    updateFailedTitle:
                        'inventory.locations.form.toasts.updateFailedTitle',
                    updateFailedMessage:
            ...
            table: {
                ...
                toasts: {
                    deleteFailedTitle:
                        'inventory.locations.table.toasts.deleteFailedTitle',
                    deleteFailedMessage:
            ...
            view: {
                ...
                sections: {
                    locationInformation:
                        'inventory.locations.view.sections.locationInformation',
                    auditInformation:
                        'inventory.locations.view.sections.auditInformation',
                    systemInformation:
                        'inventory.locations.view.sections.systemInformation',
                ...
                placeholders: {
                    noAddressProvided:
                        'inventory.locations.view.placeholders.noAddressProvided',
        ...
        stockTransfers: {
            ...
            form: {
                ...
                sections: {
                    ...
                    selectedProduct:
                        'inventory.stockTransfers.form.sections.selectedProduct',
                    transferRoute: 'inventory.stockTransfers.form.sections.transferRoute',
                    transferSummary:
                        'inventory.stockTransfers.form.sections.transferSummary',
                    transferTimeline:
                        'inventory.stockTransfers.form.sections.transferTimeline',
                    ...
                    transferHistory:
                        'inventory.stockTransfers.form.sections.transferHistory',
                    noHistoryAvailable:
                        'inventory.stockTransfers.form.sections.noHistoryAvailable',
                    transferCreated:
                        'inventory.stockTransfers.form.sections.transferCreated',
                },
                fields: {
                ...
                placeholders: {
                    searchProduct:
                        'inventory.stockTransfers.form.placeholders.searchProduct',
                    searchPrompt:
                        'inventory.stockTransfers.form.placeholders.searchPrompt',
                    selectWarehouse:
                    ...
                    searchToStart:
                        'inventory.stockTransfers.form.placeholders.searchToStart',
                    notSpecified:
                        'inventory.stockTransfers.form.placeholders.notSpecified',
                ...
                labels: {
                    ...
                    statusWithValue:
                        'inventory.stockTransfers.form.labels.statusWithValue',
                },
                validation: {
                    selectProduct:
                        'inventory.stockTransfers.form.validation.selectProduct',
                    selectFromLocation:
                    ...
                    invalidQuantity:
                        'inventory.stockTransfers.form.validation.invalidQuantity',
                    searchRequired:
                        'inventory.stockTransfers.form.validation.searchRequired',
                    invalidProductId:
                        'inventory.stockTransfers.form.validation.invalidProductId',
                },
                actions: {
                    cancel: 'inventory.stockTransfers.form.actions.cancel',
                    createTransfer:
                        'inventory.stockTransfers.form.actions.createTransfer',
                ...
                toasts: {
                    ...
                    searchFailedTitle:
                        'inventory.stockTransfers.form.toasts.searchFailedTitle',
                    searchFailedMessage:
                        'inventory.stockTransfers.form.toasts.searchFailedMessage',
                    searchErrorTitle:
                        'inventory.stockTransfers.form.toasts.searchErrorTitle',
                    searchErrorMessage:
                        'inventory.stockTransfers.form.toasts.searchErrorMessage',
                    invalidInputTitle:
                        'inventory.stockTransfers.form.toasts.invalidInputTitle',
                    invalidInputMessage:
            ...
            view: {
                ...
                sections: {
                    ...
                    productInformation:
                        'inventory.stockTransfers.view.sections.productInformation',
                    transferItem: 'inventory.stockTransfers.view.sections.transferItem',
                    transferSummary:
                        'inventory.stockTransfers.view.sections.transferSummary',
                    transferHistory:
                        'inventory.stockTransfers.view.sections.transferHistory',
                ...
                fields: {
                    ...
                    createdByUserId:
                        'inventory.stockTransfers.view.fields.createdByUserId',
                },
                placeholders: {
                    fromLocation:
                        'inventory.stockTransfers.view.placeholders.fromLocation',
                    toLocation: 'inventory.stockTransfers.view.placeholders.toLocation',
                    notSpecified:
                        'inventory.stockTransfers.view.placeholders.notSpecified',
                ...
                labels: {
                    ...
                    statusWithValue:
                        'inventory.stockTransfers.view.labels.statusWithValue',
                },
            },
        },
    },
    sales: {
        shared: {
            loading: 'sales.shared.loading',
            close: 'sales.shared.close',
            cancel: 'sales.shared.cancel',
            save: 'sales.shared.save',
            saveChanges: 'sales.shared.saveChanges',
            create: 'sales.shared.create',
            edit: 'sales.shared.edit',
            delete: 'sales.shared.delete',
            view: 'sales.shared.view',
            back: 'sales.shared.back',
            confirm: 'sales.shared.confirm',
            search: 'sales.shared.search',
            noResults: 'sales.shared.noResults',
            required: 'sales.shared.required',
            optional: 'sales.shared.optional',
        },
        orders: {
            page: {
                title: 'sales.orders.page.title',
                description: 'sales.orders.page.description',
                newOrder: 'sales.orders.page.newOrder',
                viewAllOrders: 'sales.orders.page.viewAllOrders',
            },
            cards: {
                totalOrders: {
                    title: 'sales.orders.cards.totalOrders.title',
                    description: 'sales.orders.cards.totalOrders.description',
                },
                pendingOrders: {
                    title: 'sales.orders.cards.pendingOrders.title',
                    description: 'sales.orders.cards.pendingOrders.description',
                },
                completedOrders: {
            ...
            status: {
                ...
                intransit: 'sales.orders.status.intransit',
                shipped: 'sales.orders.status.shipped',
                completed: 'sales.orders.status.completed',
                cancelled: 'sales.orders.status.cancelled',
                returned: 'sales.orders.status.returned',
            },
            paymentStatus: {
                unpaid: 'sales.orders.paymentStatus.unpaid',
                partiallypaid: 'sales.orders.paymentStatus.partiallypaid',
                paid: 'sales.orders.paymentStatus.paid',
            },
            table: {
                columns: {
                    orderNumber: 'sales.orders.table.columns.orderNumber',
                    customer: 'sales.orders.table.columns.customer',
                    date: 'sales.orders.table.columns.date',
                    items: 'sales.orders.table.columns.items',
                    total: 'sales.orders.table.columns.total',
                    status: 'sales.orders.table.columns.status',
                    paymentStatus: 'sales.orders.table.columns.paymentStatus',
                    actions: 'sales.orders.table.columns.actions',
                },
                walkIn: 'sales.orders.table.walkIn',
                emptyState: {
                    title: 'sales.orders.table.emptyState.title',
                    description: 'sales.orders.table.emptyState.description',
                    noFiltersTitle: 'sales.orders.table.emptyState.noFiltersTitle',
                    noFiltersDescription:
                        'sales.orders.table.emptyState.noFiltersDescription',
                },
                filters: {
                    status: 'sales.orders.table.filters.status',
                    customer: 'sales.orders.table.filters.customer',
                    dateFrom: 'sales.orders.table.filters.dateFrom',
                    dateTo: 'sales.orders.table.filters.dateTo',
                    allStatuses: 'sales.orders.table.filters.allStatuses',
                    allCustomers: 'sales.orders.table.filters.allCustomers',
                    clearFilters: 'sales.orders.table.filters.clearFilters',
                },
            },
            actions: {
                updatePayment: 'sales.orders.actions.updatePayment',
                confirm: 'sales.orders.actions.confirm',
                markInTransit: 'sales.orders.actions.markInTransit',
                ship: 'sales.orders.actions.ship',
                complete: 'sales.orders.actions.complete',
                cancel: 'sales.orders.actions.cancel',
                return: 'sales.orders.actions.return',
                edit: 'sales.orders.actions.edit',
                view: 'sales.orders.actions.view',
            },
            updatePayment: {
                title: 'sales.orders.updatePayment.title',
                description: 'sales.orders.updatePayment.description',
                paymentStatusLabel: 'sales.orders.updatePayment.paymentStatusLabel',
                amountLabel: 'sales.orders.updatePayment.amountLabel',
                amountPlaceholder: 'sales.orders.updatePayment.amountPlaceholder',
                totalAmountLabel: 'sales.orders.updatePayment.totalAmountLabel',
                partialAmountHint: 'sales.orders.updatePayment.partialAmountHint',
                partialAmountInvalid:
                    'sales.orders.updatePayment.partialAmountInvalid',
            },
            confirmDialog: {
                confirmTitle: 'sales.orders.confirmDialog.confirmTitle',
                confirmMessage: 'sales.orders.confirmDialog.confirmMessage',
                transitTitle: 'sales.orders.confirmDialog.transitTitle',
                transitMessage: 'sales.orders.confirmDialog.transitMessage',
                shipTitle: 'sales.orders.confirmDialog.shipTitle',
                shipMessage: 'sales.orders.confirmDialog.shipMessage',
                trackingNumber: 'sales.orders.confirmDialog.trackingNumber',
                trackingNumberPlaceholder:
                    'sales.orders.confirmDialog.trackingNumberPlaceholder',
                completeTitle: 'sales.orders.confirmDialog.completeTitle',
                completeMessage: 'sales.orders.confirmDialog.completeMessage',
                cancelTitle: 'sales.orders.confirmDialog.cancelTitle',
                cancelMessage: 'sales.orders.confirmDialog.cancelMessage',
                returnTitle: 'sales.orders.confirmDialog.returnTitle',
                returnMessage: 'sales.orders.confirmDialog.returnMessage',
            },
            create: {
                title: 'sales.orders.create.title',
                walkInToggle: 'sales.orders.create.walkInToggle',
                walkInDescription: 'sales.orders.create.walkInDescription',
                selectCustomer: 'sales.orders.create.selectCustomer',
                selectCustomerPlaceholder:
                    'sales.orders.create.selectCustomerPlaceholder',
                notes: 'sales.orders.create.notes',
                notesPlaceholder: 'sales.orders.create.notesPlaceholder',
                orderSummary: 'sales.orders.create.orderSummary',
                subtotal: 'sales.orders.create.subtotal',
                total: 'sales.orders.create.total',
                createOrder: 'sales.orders.create.createOrder',
                completeSale: 'sales.orders.create.completeSale',
                creating: 'sales.orders.create.creating',
            },
            items: {
                title: 'sales.orders.items.title',
                addItem: 'sales.orders.items.addItem',
                product: 'sales.orders.items.product',
                searchById: 'sales.orders.items.searchById',
                searchBySku: 'sales.orders.items.searchBySku',
                searchPlaceholderId: 'sales.orders.items.searchPlaceholderId',
                searchPlaceholderSku: 'sales.orders.items.searchPlaceholderSku',
                search: 'sales.orders.items.search',
                searchToLoadProducts: 'sales.orders.items.searchToLoadProducts',
                searchingProducts: 'sales.orders.items.searchingProducts',
                searchFailed: 'sales.orders.items.searchFailed',
                noMatchingProducts: 'sales.orders.items.noMatchingProducts',
                invalidProductId: 'sales.orders.items.invalidProductId',
                productNotFound: 'sales.orders.items.productNotFound',
                selectProduct: 'sales.orders.items.selectProduct',
                location: 'sales.orders.items.location',
                selectLocation: 'sales.orders.items.selectLocation',
                loadingLocations: 'sales.orders.items.loadingLocations',
                failedToLoadLocations: 'sales.orders.items.failedToLoadLocations',
                noInventoryAvailable: 'sales.orders.items.noInventoryAvailable',
                quantity: 'sales.orders.items.quantity',
                unitPrice: 'sales.orders.items.unitPrice',
                subtotal: 'sales.orders.items.subtotal',
                remove: 'sales.orders.items.remove',
                retry: 'sales.orders.items.retry',
                availableStock: 'sales.orders.items.availableStock',
                noStock: 'sales.orders.items.noStock',
                selectProductFirst: 'sales.orders.items.selectProductFirst',
                duplicateWarning: 'sales.orders.items.duplicateWarning',
                noItems: 'sales.orders.items.noItems',
                noItemsDescription: 'sales.orders.items.noItemsDescription',
            },
            detail: {
                title: 'sales.orders.detail.title',
                orderInfo: 'sales.orders.detail.orderInfo',
                customer: 'sales.orders.detail.customer',
                orderDate: 'sales.orders.detail.orderDate',
                status: 'sales.orders.detail.status',
                paymentStatus: 'sales.orders.detail.paymentStatus',
                notes: 'sales.orders.detail.notes',
                noNotes: 'sales.orders.detail.noNotes',
                shippingAddress: 'sales.orders.detail.shippingAddress',
                noShippingAddress: 'sales.orders.detail.noShippingAddress',
                trackingNumber: 'sales.orders.detail.trackingNumber',
                noTrackingNumber: 'sales.orders.detail.noTrackingNumber',
                lineItems: 'sales.orders.detail.lineItems',
                orderTotal: 'sales.orders.detail.orderTotal',
                notFound: 'sales.orders.detail.notFound',
                notFoundDescription: 'sales.orders.detail.notFoundDescription',
            },
            edit: {
                title: 'sales.orders.edit.title',
                onlyPendingCanEdit: 'sales.orders.edit.onlyPendingCanEdit',
                saveChanges: 'sales.orders.edit.saveChanges',
                saving: 'sales.orders.edit.saving',
            },
            toasts: {
                createSuccess: 'sales.orders.toasts.createSuccess',
                createError: 'sales.orders.toasts.createError',
                updateSuccess: 'sales.orders.toasts.updateSuccess',
                updateError: 'sales.orders.toasts.updateError',
                confirmSuccess: 'sales.orders.toasts.confirmSuccess',
                confirmError: 'sales.orders.toasts.confirmError',
                transitSuccess: 'sales.orders.toasts.transitSuccess',
                transitError: 'sales.orders.toasts.transitError',
                shipSuccess: 'sales.orders.toasts.shipSuccess',
                shipError: 'sales.orders.toasts.shipError',
                completeSuccess: 'sales.orders.toasts.completeSuccess',
                completeError: 'sales.orders.toasts.completeError',
                cancelSuccess: 'sales.orders.toasts.cancelSuccess',
                cancelError: 'sales.orders.toasts.cancelError',
                returnSuccess: 'sales.orders.toasts.returnSuccess',
                returnError: 'sales.orders.toasts.returnError',
                updatePaymentSuccess: 'sales.orders.toasts.updatePaymentSuccess',
                updatePaymentError: 'sales.orders.toasts.updatePaymentError',
                validationError: 'sales.orders.toasts.validationError',
                atLeastOneItem: 'sales.orders.toasts.atLeastOneItem',
            },
        },
    },
};
