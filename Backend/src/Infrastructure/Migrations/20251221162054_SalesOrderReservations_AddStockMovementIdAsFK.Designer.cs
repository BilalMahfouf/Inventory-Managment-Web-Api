...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20251221162054_SalesOrderReservations_AddStockMovementIdAsFK")]
    partial class SalesOrderReservations_AddStockMovementIdAsFK
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.Customer", b =>
                {
                    ...
                    b.ComplexProperty(typeof(Dictionary<string, object>), "Address", "Domain.Entities.Customer.Address#Address", b1 =>
                        {
                            b1.IsRequired();
            ...
            modelBuilder.Entity("Domain.Sales.SalesOrder", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Domain.Sales.SalesOrderItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Domain.Sales.SalesOrderReservation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Domain.Entities.Products.ProductCategory", b =>
                {
                    ...
                    b.HasOne("Domain.Entities.Products.ProductCategory", "Parent")
                        .WithMany()
            ...
            modelBuilder.Entity("Domain.Sales.SalesOrderItem", b =>
                {
                    ...
                    b.HasOne("Domain.Sales.SalesOrder", "SalesOrder")
                        .WithMany("Items")
            ...
            modelBuilder.Entity("Domain.Sales.SalesOrderReservation", b =>
                {
                    ...
                    b.HasOne("Domain.Sales.SalesOrder", null)
