...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20260329211254_RefactorToSharedEntityBase")]
    partial class RefactorToSharedEntityBase
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Sales.Entities.SalesOrderReservation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("StockMovemntId");

                    b.ToTable("SalesOrderReservations", (string)null);
                });
            ...
            modelBuilder.Entity("Domain.Sales.Entities.SalesOrderReservation", b =>
                {
                    ...
                    b.HasOne("Domain.Inventories.Entities.Inventory", null)
                        .WithMany()
                        .HasForeignKey("InventoryId")
                        .IsRequired();

                    b.HasOne("Domain.Sales.Entities.SalesOrder", null)
                        .WithMany("Reservations")
                        .HasForeignKey("OrderId")
                        .IsRequired();

                    b.HasOne("Domain.Products.Entities.Product", null)
                        .WithMany()
                        .HasForeignKey("ProductId")
                        .IsRequired();
